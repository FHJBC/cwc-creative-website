...
$(function () {
  ...
  // close the current opend menu when click on its wrapper
  ...
  if ($('.testimonials-3d  .swiper-container').length) {
    let testimonialsSlider_1 = new Swiper(
  ...
  if ($('.testimonials-2-col .swiper-container').length) {
    let testimonialsSlider_2 = new Swiper(
  ...
  if ($('.testimonials-3-col .swiper-container').length) {
    let testimonialsSlider_3 = new Swiper(
  ...
  if ($('.our-clients .swiper-container').length) {
    let partenersSlider = new Swiper('.our-clients .swiper-container', {
      // Optional parameters
      speed: 600,
      loop: true,
      spaceBetween: 30,
  ...
  if ($('.post-main-area .post-featured-area .swiper-container').length) {
    let partenersSlider = new Swiper(
  ...
  if ($('.portfolio-slider .swiper-container').length) {
    let swiperPortfolioSlider = new Swiper(
  ...
  if (
    ...
    let swiperPortfolioSingleSlider = new Swiper(
  ...
  if (jQuery().vegas) {
    ...
    let slides = $('.hero-vegas-slider .vegas-slider-content'),
  ...
  /* start mail chimp  */
  if (jQuery().ajaxChimp) {
    let subscribeUrl = $('.mc-form').attr('action');

    // alert lets
    let alerts = $('.mailchimp-alerts'),
      msgAll = $('.mc-msg'),
